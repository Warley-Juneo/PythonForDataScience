...
def main(*args):
    """
        This function takes a string as an argument and counts the number of upper and lower case letters, punctuation marks, spaces and digits in the string.
    ...
    total_characters = upper_letters + lower_letters + punctuation + spaces + digits
