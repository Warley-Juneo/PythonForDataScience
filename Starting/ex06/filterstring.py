...
def filter_words(string, length):
    """
    Filtra palavras de uma string que têm um comprimento maior que um determinado comprimento
    ...
    Returns:
        List[str]: Uma lista de palavras da string que têm um comprimento maior que o comprimento dado
    """
